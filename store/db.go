...
func Init(cfg *config.Config) {
	...
	if err := DB.AutoMigrate(&User{}, &Connection{}, &DataMigrationJob{}, &DataMigrationReport{}, &IncrementalMigrationJob{}, &IncrementalMigrationLog{}, &LoginHistory{}, &BatchMigration{}, &MigrationTicket{}); err != nil {
