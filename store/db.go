...
func Init(cfg *config.Config) {
	...
	if err := DB.AutoMigrate(&User{}, &Connection{}, &MigrationHistory{}, &DataMigrationJob{}, &DataMigrationReport{}, &IncrementalMigrationJob{}, &IncrementalMigrationLog{}, &LoginHistory{}, &BatchMigration{}, &MigrationTicket{}); err != nil {
